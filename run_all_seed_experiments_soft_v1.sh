#!/bin/bash
# Soft-constraint v1: 按随机种子分组依次运行
# seed_1: SWC-PSWM -> Exp-A -> Exp-B -> Exp-C -> Exp-D
#
# 用法：
#   bash run_all_seed_experiments_soft_v1.sh >& run_all_seed_experiments_soft_v1.log
...
CFG_DIR="scripts/machine_learning_code/configs/paper/seeds_soft_v1"
LOG_DIR="scripts/machine_learning_code/logs_20260323_3/seed_runs_soft_v1"
...
for seed in "${SEEDS[@]}"; do
    echo "======================================================================"
    echo "开始随机种子 seed=${seed} 的一组 soft_v1 实验"
    echo "时间: $(date '+%Y-%m-%d %H:%M:%S')"
    echo "======================================================================"

    for variant in "${VARIANTS[@]}"; do
        COUNT=$((COUNT + 1))
        cfg_name="${variant}_soft_v1_seed${seed}"
...
echo "======================================================================"
echo "全部 ${TOTAL} 个 soft_v1 seed 实验已完成！ $(date '+%Y-%m-%d %H:%M:%S')"
echo "日志目录: ${LOG_DIR}"
echo "======================================================================"
