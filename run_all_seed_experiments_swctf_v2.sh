#!/bin/bash
# SWC-TF v2 并行版：按 seed 并发运行，每个 seed 内仍保持
# SWC-PSWM -> Exp-A2 -> Exp-B2 -> Exp-C2 -> Exp-D2 -> (SVM/LSTM/Transformer) 的顺序。
#
# 用法：
#   MAX_PARALLEL_SEEDS=5 bash run_all_seed_experiments_swctf_v2.sh |& tee run_all_seed_experiments_swctf_v2_m5.log
...
CFG_DIR="scripts/machine_learning_code/configs/paper/seeds_swctf_v2"
LOG_DIR="scripts/machine_learning_code/logs_20260323_4/seed_runs_swctf_v2"
...
run_one_seed() {
...

    {
        ...
        local expd_cfg="${CFG_DIR}/exp_d2_plus_swctf_seed${seed}.yaml"
