...
def main():
    base_folder = "C:\\Users\\asus\\Desktop\\ROG桌面其他文件\\电解水\\20240721测试0721-3.1快速降温"
    subfolders = [
        "EISGALV_90℃_150ml_1A",
        "EISGALV_80℃_150ml_1A",
        "EISGALV_70℃_150ml_1A",
        "EISGALV_60℃_150ml_1A",
        "EISGALV_50℃_150ml_1A",
        "EISGALV_40℃_150ml_1A"
        #"EISGALV_35℃_150ml_1A",
    ]

    file_patterns = []
    for subfolder in subfolders:
        for i in range(1, 3):
            file_patterns.append(os.path.join(subfolder, f"cm2_20240721_no_inject_3.{i}.DTA"))
    output_folder = os.path.join(base_folder, "output_drt")
    entries = []
    ...
    for file_name in file_patterns:
        ...
        if os.path.isfile(file_path):
            if os.path.isfile(output_path):
                ...
                kk_valid, error = kramers_kronig_check(eis_entry.freq, eis_entry.Z_prime, eis_entry.Z_double_prime)
