...
def save_data_to_excel(input_dir, dta_files, output_dir):
    ...
    if '_ion_column_renew_H2SO4_' in dta_file:
        output_file = os.path.join(output_dir, f"{input_dir.split(os.sep)[-3]}_ion_column_renew_H2SO4_gamry.xlsx")
    elif '_ion_column_' in dta_file:
        output_file = os.path.join(output_dir, f"{input_dir.split(os.sep)[-3]}_ion_column_gamry.xlsx")
    elif '_ion_' in dta_file:
        output_file = os.path.join(output_dir, f"{input_dir.split(os.sep)[-3]}_ion_gamry.xlsx")
